...
console.info(bst.size());
console.info(bst.min());
console.info(bst.max());

console.info(bst.contains(2));
console.info(bst.contains(9));

// depth first search - branch by branch
// in-order: 2, 3, 12, 15, 28, 36, 39
console.info(bst.dfsInOrder());

// pre-order: 15, 3, 2, 12, 36, 28, 39
console.info(bst.dfsPreOrder());

// post-order: 2, 12, 3, 28, 39, 36, 15
console.info(bst.dfsPostOrder());

// breadth first search - level by level
// 15, 3, 36, 2, 12, 28, 39
console.info(bst.bfs());
